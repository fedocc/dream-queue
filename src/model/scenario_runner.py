...
def scenario_row(config: dict, scenario_name: str) -> dict[str, float | str]:
    ...
    return {
        ...
        "output_label": "scenario output",
        "assumptions_label": "product and risk values are assumptions, not measured Dream Island data",
        ...
        "paid_capacity_cap_assumption": peak_optimized.assumptions_used.get("paid_capacity_cap", ""),
        "route_compliance_rate_assumption": peak_optimized.assumptions_used.get("route_compliance_rate", ""),
        "ride_downtime_probability_assumption": peak_optimized.assumptions_used.get("ride_downtime_probability", ""),
        "no_show_rate_assumption": peak_optimized.assumptions_used.get("no_show_rate", ""),
        "late_arrival_rate_assumption": peak_optimized.assumptions_used.get("late_arrival_rate", ""),
        "abandon_rate_assumption": peak_optimized.assumptions_used.get("abandon_rate", ""),
        "peak_day_fast_slots_sold": peak_optimized.paid_slots_sold,
        "normal_day_fast_slots_sold": normal_optimized.paid_slots_sold,
        "peak_paid_slot_no_shows_model_output": peak_optimized.risk_outputs.get("paid_slot_no_shows", 0),
        "peak_late_arrivals_model_output": peak_optimized.risk_outputs.get("late_arrivals", 0),
        "peak_abandoned_slots_model_output": peak_optimized.risk_outputs.get("abandoned_slots", 0),
        "peak_downtime_steps_model_output": peak_optimized.risk_outputs.get("downtime_steps", 0),
